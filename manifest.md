...
هر مانیفست از هفت بخش تشکیل می‌شود:
...
**events** — رویدادهایی که این بخش منتشر می‌کند. این فیلد باید با بخش پیام‌های قرارداد همخوانی داشته باشد.
...
* رویدادهای اعلام‌شده در مانیفست باید با پیام‌های تعریف‌شده در قرارداد همخوانی داشته باشند