...
مانیفست با قرارداد فرق دارد. قرارداد توافق رسمی که مشخص می‌کند این بخش چه عملیات‌هایی پیاده‌سازی کرده، چه پیام‌هایی می‌پذیرد، و چه پیام‌هایی منتشر می‌کند. مانیفست مشخص می‌کند یک بخش چه کسی است، چه نسخه‌ای دارد، چه قراردادی را پیاده‌سازی کرده، و به چه چیزی نیاز دارد.
...
**channel** — اعلام نیاز به مجرای خصوصی. این فیلد اختیاری است و فقط در صورتی تعریف می‌شود که بخش به مجرای خصوصی نیاز دارد.
