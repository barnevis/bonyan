...
**Manifest** — The file that defines the module's identity, version, architectural compatibility, implemented contract, dependencies, configuration, and events. The Core recognizes and loads the module based on the manifest.
...
* A module should not know who receives its events.
